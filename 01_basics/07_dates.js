...
its time in the ms, starting from 1st jan 1970(default value given by ecma script)
till now which is in the parameter
 */
...
console.log(newDate.getMonth() + 1); //think why we have added 1
